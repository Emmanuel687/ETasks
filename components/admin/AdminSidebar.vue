<template>
  <div>
    ...
    <!-- Sidebar -->
    <div :class="[
      'bg-gray-900 text-white w-64 min-h-screen flex flex-col transition-all duration-300 ease-in-out',
      ...
      <nav class="flex-1 px-2 py-4 space-y-2">
        <NuxtLink to="/admin"
          class="flex items-center space-x-2 px-4 py-3 rounded transition duration-200 hover:bg-gray-800 hover:text-indigo-400">
      ...
      <div class="p-4">
        <button @click="handleLogout"
          class="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition duration-200">
