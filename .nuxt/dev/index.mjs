...
import { stringify, uneval } from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/devalue@5.0.0/node_modules/devalue/index.js';
...
import { renderToString } from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/vue@3.5.8/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/@unhead+ssr@1.11.6/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/ofetch@1.4.0/node_modules/ofetch/dist/node.mjs';
...
import { isVNode, version, unref } from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/vue@3.5.8/node_modules/vue/index.mjs';
import BaseStyle from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/@primevue+core@4.0.7_vue@3.5.8/node_modules/@primevue/core/base/style/index.mjs';
import { Theme } from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/@primeuix+styled@0.0.5/node_modules/@primeuix/styled/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/unhead@1.11.6/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/@unhead+shared@1.11.6/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/emmanuel/Desktop/TaskManager-Supabase/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/emmanuel/Desktop/TaskManager-Supabase","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/emmanuel/Desktop/TaskManager-Supabase/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/emmanuel/Desktop/TaskManager-Supabase/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/emmanuel/Desktop/TaskManager-Supabase/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/emmanuel/Desktop/TaskManager-Supabase/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _cUAOAjufOp = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/emmanuel/Desktop/TaskManager-Supabase";
...
const _Y7XrSaTc6m = defineNitroPlugin(async (nitroApp) => {
...
const getClientManifest = () => import('file:///Users/emmanuel/Desktop/TaskManager-Supabase/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/emmanuel/Desktop/TaskManager-Supabase/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
