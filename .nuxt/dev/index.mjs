...
import BaseStyle from 'file:///Users/emmanuel/Desktop/TaskManager-Supabase/node_modules/.pnpm/@primevue+core@4.0.7_vue@3.5.11/node_modules/@primevue/core/base/style/index.mjs';
...
const _dX2NVdvpYy = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_tiM7Nk = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_tiM7Nk, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_tiM7Nk, lazy: true, middleware: false, method: undefined }
];
